...
// Usage
const limitedFunc = rateLimit(() => console.log('Function called!'), 1000);
limitedFunc(); // Will execute immediately
limitedFunc(); // Will be ignored if called within 1 second
