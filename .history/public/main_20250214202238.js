const LOCAL_IP = process.env.localIPV4 || 'localhost'
const LOCAL_PORT = process.env.localPort || 4000

const socket = io(`wss://${LOCAL_IP}:${LOCAL_PORT}`) // Replace with your local IP address
