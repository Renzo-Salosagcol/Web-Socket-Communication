...
app.get('/', checkAuthenticated, waitForSocketConnection, (req, res) => {
  res.render('index.ejs', { name: req.user.name, rooms: req.session.user.rooms });
});
...
// Rooms
function waitForSocketConnection(req, res, next) {
