...
> 
> In your terminal, type <code>ipconfig</code> to list your network connections. Whether you are connected via WiFi or Ethernet, you will need to use the IPv4 Address. Create a variable named <code>LOCAL_IP</code> and assign the value of your IPv4 Address to it as well as
> 
